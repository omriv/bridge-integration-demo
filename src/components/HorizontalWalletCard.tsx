              ...
              <div className="space-y-3">
                ...
                <div className="mt-3 flex gap-3">
                  <button
                    ...
                    className="bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 px-4 py-2 rounded-lg font-semibold hover:bg-amber-500/20 transition-all flex items-center gap-2"
                  >
