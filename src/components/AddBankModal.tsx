            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Account Owner Name *</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Bank Name</label>
                    <input
                      type="text"
                      name="bank_name"
                ...
                <div className="bg-neutral-50 dark:bg-neutral-800/50 p-4 rounded-lg border border-neutral-200 dark:border-neutral-700 space-y-4">
                  ...
                  {accountType === 'us' && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="sm:col-span-2">
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Routing Number *</label>
                        <input
                          type="text"
                          name="routing_number"
                          required
                      ...
                      <div className="sm:col-span-2">
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Account Number *</label>
                        <input
                          type="text"
                          name="account_number"
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Account Type</label>
                        <select
                  ...
                  {accountType === 'iban' && (
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">IBAN *</label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">BIC (Optional)</label>
                          <input
                            type="text"
                            name="iban_bic"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Country (ISO) *</label>
                          <input
                            type="text"
                            name="iban_country"
                            required
                  ...
                  {accountType === 'swift' && (
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">BIC *</label>
                          <input
                            type="text"
                            name="swift_bic"
                            required
                        ...
                        <div>
                          <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Bank Country *</label>
                          <input
                            type="text"
                            name="swift_country"
                            required
                      ...
                      <div className="border-t border-neutral-200 dark:border-neutral-700 pt-2">
                        <h4 className="text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-2">Bank Address *</h4>
                        <div className="grid grid-cols-2 gap-4">
                          <div className="col-span-2">
                            <input
                              type="text"
                              ...
                              onChange={handleInputChange}
                              className="w-full px-3 py-2 bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-600 rounded-lg text-neutral-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 mb-2 placeholder-neutral-400 dark:placeholder-neutral-500"
                            />
                          </div>
                          <input
                            type="text"
                      ...
                      <div className="border-t border-neutral-200 dark:border-neutral-700 pt-2">
                        <h4 className="text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-2">Additional Info</h4>
                  ...
                  {accountType === 'clabe' && (
                    <div>
                      <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">CLABE Account Number *</label>
                      <input
                        type="text"
                  ...
                  {accountType === 'pix_key' && (
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Pix Key *</label>
                        <input
                          type="text"
                          name="pix_key"
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Document Number *</label>
                        <input
                          type="text"
                  ...
                  {accountType === 'pix_br_code' && (
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">BR Code *</label>
                        <input
                          type="text"
                          name="br_code_string"
                          required
                  ...
                  {accountType !== 'us' && (
                    <div className="border-t border-neutral-200 dark:border-neutral-700 pt-4 mt-4">
                      <h4 className="text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-2">Owner Details</h4>
                      <div className="space-y-4">
                        <div>
                          <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Owner Type</label>
                          <select
                        ...
                        {formData.account_owner_type === 'individual' ? (
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">First Name *</label>
                              <input
                                type="text"
                                name="first_name"
                                required
                            ...
                            <div>
                              <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Last Name *</label>
                              <input
                                type="text"
                                name="last_name"
                                required
                          ...
                          <div>
                            <label className="block text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">Business Name *</label>
                            <input
                              type="text"
                              name="business_name"
                              required
                ...
                <div className="border-t border-neutral-200 dark:border-neutral-700 pt-4">
                  <h3 className="text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">Beneficiary Address (Optional)</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2">
                      <input
                        type="text"
